...
import oferty.zarzadzanie_oferta_sieci as zo_sieci

from oferty.Constants import Constants


class TestOfertaSieci(unittest.TestCase):

    def test_waliduj_danie(self):
        waliduj_danie = zo_sieci.waliduj_danie
    ...
    def test_waliduj_nazwe(self):
        waliduj_nazwe = zo_sieci.waliduj_nazwe
    ...
    def test_waliduj_cene(self):
        waliduj_cene = zo_sieci.waliduj_cene
    ...
    def test_waliduj_opis(self):
        waliduj_opis = zo_sieci.waliduj_opis()
        opis = "abcde"
